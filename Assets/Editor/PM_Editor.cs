...
public class PM_Editor : EditorWindow
{
    ...
    [MenuItem("Window/TIME BUSTERS X' PLAYER MOVEMENT EDITOR")]

    public static void ShowWindow()
    {
        GetWindow<PM_Editor>("TIME BUSTERS X' PLAYER MOVEMENT EDITOR");
    }
    ...
    private void OnGUI()
    {
        ...
        Texture2D logo = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/tbx_pme_logo.png", typeof(Texture2D));
        ...
        if (showHelp)
        {
            GUILayout.Label("This is the HELP for the Player Movement Editor:\nTo actually" +
                "change in -game values, change the parameters,\nselect the '_Player' and last," +
