...
public class WB_Editor : EditorWindow
{
    ...
    [MenuItem("Window/TIME BUSTERS X' WEAPON BUILDER EDITOR")]

    public static void ShowWindow()
    {
        GetWindow<WB_Editor>("TIME BUSTERS X' WEAPON BUILDER EDITOR");
    }
    ...
    private void OnGUI()
    {
        ...
        Texture2D logo = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/tbx_wbe_logo.png", typeof(Texture2D));
        ...
        if (showHelp)
        {
            GUILayout.Label("This is the HELP for the Weapon Builder Editor:\nTo actually" +
